...
$ReportFile = "C:\Users\James.Oliver\Desktop\BitLocker_Status_$Date.csv"
$OutputArray = @()
$Recipients = "james.oliver@garbutt-elliott.co.uk"
$Sender = "BitLockerReport@garbutt-elliott.co.uk"
$SMTPServer = "GE-Ouse"
# $SearchBase = "DC=garbutt-elliott,DC=lan" - Not used. 
...
Try
{
   $Computers = Get-ADComputer -filter {Name -like "*GE-LT*"-or Name -like "*GE-DT*"} -Properties Name,Description | Sort-Object 
