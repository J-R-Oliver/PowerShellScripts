...
$tenant = 'StAnnesCommunityServices' # xxxx.onmicrosoft.com
$tenantId = 'eb0b2d12-e5eb-41e9-8e54-fbd3df00f7c7' #Tenant ID, can be retrieved from Azure AD or PowerShell under optional.
$siteName = 'Team%Files' #Sharepoint site name
$docLib = 'IT' #Sharepoint Document Library
